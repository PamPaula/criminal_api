package com.gft.criminal_api.filters;
...
import com.gft.criminal_api.services.UsuarioService;
...
public class FiltroAutenticacao extends OncePerRequestFilter {
	...
	protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain)
		...
		if(autenticacaoService.verificaToken(token)) {
			...
			.setAuthentication(new UsernamePasswordAuthenticationToken(idUsuario, null, usuario.getAuthorities()));
		}
